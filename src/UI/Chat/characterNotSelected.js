...
export function characterNotSelected() {
  ...
  app.innerHTML = `
    <div class="section section-chat active">
      ...
      <div class="nf-code">STOP</div>
      <span class="logo-badge" style="margin:0 0 20px">No has Seleccionado un Sospechoso</span>
      ...
      <div class="glass" style="display:flex;align-items:center;gap:10px;padding:14px 16px;margin-bottom:28px;max-width:340px;width:100%">
        ...
        <span style="font-size:12px;color:var(--muted);line-height:1.5">
          <strong style="color:var(--text)">Consejo:</strong>
          algunos personajes mienten, otros recuerdan mal. Contrasta sus versiones para encontrar al culpable.
        </span>
      </div>
